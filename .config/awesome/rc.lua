...
-- Alt-Tab compatibility, https://github.com/blueyed/awesome-cyclefocus
...
beautiful.wallpaper = awful.util.get_configuration_dir() .. "themes/wallpaper.png"
